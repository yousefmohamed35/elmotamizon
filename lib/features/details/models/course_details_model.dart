...
class CourseModel extends Equatable {
  ...
  factory CourseModel.fromJson(Map<String, dynamic> json) {
    return CourseModel(
      ...
      inFavorite: json["is_favorited"] ?? 0,
      isFree: json["is_free"] ?? 0,
      progress: json["progress"] == null
          ? null
          : ProgressData.fromJson(json["progress"]),
      searchData:
          json["items"] == null ? null : SearchData.fromJson(json["items"]),
      type: json["type"] ?? "",
...
class ProgressData extends Equatable {
  ...
  @override
  List<Object?> get props =>
      [viewedLessons, totalLessons, percent, isCompleted];
}
...
class SearchData extends Equatable {
  ...
  @override
  List<Object?> get props =>
      [type, id, name, image, price, description, teacherId, updatedAt];
}
